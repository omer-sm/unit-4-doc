...
export default function Footer() {
    return (
        <Sheet sx={{width: "100%", height: "fit-content", paddingBottom: 8, display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column"}}>
            ...
            <Typography level="body-sm">קוד המקור של האתר זמין לצפיה <Typography component="a" href="https://github.com/omer-sm/unit404" variant="plain" color="primary">בגיטהאב</Typography></Typography>
        </Sheet>
    )
}